 ...
 *    8base invoke-local TestEnvFunc -p src/resolvers/TestEnvFunc/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local TestEnvFunc -m request
 *
 ...
 *    8base generate mock TestEnvFunc -m [MOCK_FILE_NAME]
 */
