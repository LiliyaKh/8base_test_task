 ...
 *    8base invoke-local Test3Function -p src/resolvers/Test3Function/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local Test3Function -m request
 *
 ...
 *    8base generate mock Test3Function -m [MOCK_FILE_NAME]
 */
