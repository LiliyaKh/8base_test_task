 ...
 *    8base invoke-local secondTestProjectFunction -p src/resolvers/secondTestProjectFunction/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local secondTestProjectFunction -m request
 *
 ...
 *    8base generate mock secondTestProjectFunction -m [MOCK_FILE_NAME]
 */
